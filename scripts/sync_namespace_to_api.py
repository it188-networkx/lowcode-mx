...
用法:
    python sync_namespace_to_api.py --id <namespaceID> --slug <slug> --name <name>
    python sync_namespace_to_api.py --id <namespaceID> --slug <slug> --name <name> --dry-run

示例:
    python sync_namespace_to_api.py --id 490001000000000001 --slug change --name "变更管理"
    python sync_namespace_to_api.py --id 490001000000000001 --slug change --name "变更管理" --dry-run
"""
